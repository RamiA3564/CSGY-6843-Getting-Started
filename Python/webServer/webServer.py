  ...
  while True:
    ...
    try:
      ...
      for i in f: #for line in file
        content += i #Fill in start - append your html file contents #Fill in end 
      ...
      error_header += b"<html><head><title>404 Not Found</title></head>"
      #Fill in end


      #Close client socket
      #Fill in start
      connectionSocket.sendall(error_header)
